...
export const UNTERNEHMEN = [
  {
    ...
    farbe: "#b87216", icon: "Sun", slogan: "Energie aus Bayern.",
  ...
  },
  {
    ...
    farbe: "#7a5030", icon: "Trees", slogan: "Massivholz aus dem Bayerischen Wald.",
  ...
  },
  {
    ...
    farbe: "#3d7a65", icon: "Scissors", slogan: "Qualität aus dem Allgäu.",
  ...
  },
  {
    ...
    farbe: "#3a5e88", icon: "Dumbbell", slogan: "Fitness made in Bavaria.",
