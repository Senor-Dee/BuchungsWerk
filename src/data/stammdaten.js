...
export const UNTERNEHMEN = [
  {
    ...
    farbe: "#f59e0b", icon: "Sun", slogan: "Energie aus Bayern.",
  ...
  },
  {
    ...
    farbe: "#92400e", icon: "Trees", slogan: "Massivholz aus dem Bayerischen Wald.",
  ...
  },
  {
    ...
    farbe: "#047857", icon: "Scissors", slogan: "Qualität aus dem Allgäu.",
  ...
  },
  {
    ...
    farbe: "#1d4ed8", icon: "Dumbbell", slogan: "Fitness made in Bavaria.",
