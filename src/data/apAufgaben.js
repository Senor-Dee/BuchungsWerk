...
export const AP_AUFGABE_1 = [
  ...
  },
  {
    ...
    teilaufgaben:[
      ...
      { nr:"1.5.1", punkte:3, text:"Ergänzen Sie die fehlenden Werte A–C in der Tabelle zur Vorratshaltung von VELO (Lithium-Akkus 36V/15Ah).",
        tabelle:{ headers:["Position","Angabe","Ergebnis"], rows:[
          ["Jahresbedarf (Stück)","3.600","–"],
          ["Bestellkosten je Bestellung (€)","100,00","–"],
          ["Lagerhaltungskosten je Stück und Jahr (€)","0,50","–"],
          ["Optimale Bestellmenge (Stück) [Andler-Formel]","","A"],
          ["Auswirkung auf die opt. Bestellmenge, wenn Lagerhaltungskosten steigen","qualitativ","B"],
          ["Tagesverbrauch (Stück/Tag)","10","–"],
          ["Mindestlieferzeit (Tage)","30","–"],
          ["Meldebestand (Stück)  [Tagesverbrauch × Lieferzeit]","","C"],
        ]},
        loesung:{A:"1.200 Stück",B:"sinken",C:"300 Stück"} },
    ],
  },
  {
...
export const AP_AUFGABE_3 = [
  {
    ...
    teilaufgaben:[
      { nr:"3.1", punkte:6, text:"Berechnen Sie das Betriebsergebnis des Zweigwerks Eichstätt für das 2. Quartal 2025 mithilfe der Deckungsbeitragsrechnung. Erstellen Sie dazu eine vollständige Deckungsbeitragsrechnung mit den fehlenden Werten A–F.",
        tabelle:{ headers:["","Eco-Smart","Pro-Power","Gesamt"], rows:[
          ["Nettoverkaufspreis (€/Stk)","280,00","420,00",""],
          ["Variable Kosten (€/Stk)","175,00","310,00",""],
          ["Absatzmenge (Stk)","2.400","1.800",""],
          ["NVE (€)","A","B",""],
          ["– Variable Kosten gesamt (€)","C","D",""],
          ["= Deckungsbeitrag (€)","","","E"],
          ["– Fixkosten gesamt (€)","","","188.700,00"],
          ["= Betriebsergebnis (€)","","","F"],
        ]},
        loesung:{ schema:[{pos:"NVE",eco:672000,pro:756000},{pos:"– VK",eco:420000,pro:558000},{pos:"DB",eco:252000,pro:198000,gesamt:450000},{pos:"– FK",gesamt:188700},{pos:"Gewinn",gesamt:261300}] } },
  ...
  },
  {
    ...
    teilaufgaben:[
      { nr:"3.1", punkte:6, text:"Berechnen Sie das Betriebsergebnis des Zweigwerks Vilshofen für das 3. Quartal 2025 mithilfe der Deckungsbeitragsrechnung. Erstellen Sie dazu eine vollständige Deckungsbeitragsrechnung mit den fehlenden Werten A–F.",
        tabelle:{ headers:["","CityHelm","ProHelm","Gesamt"], rows:[
          ["Nettoverkaufspreis (€/Stk)","65,00","120,00",""],
          ["Variable Kosten (€/Stk)","38,00","85,00",""],
          ["Absatzmenge (Stk)","3.600","2.100",""],
          ["NVE (€)","A","B",""],
          ["– Variable Kosten gesamt (€)","C","D",""],
          ["= Deckungsbeitrag (€)","","","E"],
          ["– Fixkosten gesamt (€)","","","147.500,00"],
          ["= Betriebsergebnis (€)","","","F"],
        ]},
        loesung:{ schema:[{pos:"NVE",city:234000,pro:252000},{pos:"– VK",city:136800,pro:178500},{pos:"DB",city:97200,pro:73500,gesamt:170700},{pos:"– FK",gesamt:147500},{pos:"Gewinn",gesamt:23200}] } },
